package com.maxsolutions.storytail.general.service.impl.config;
...
import com.maxsolutions.storytail.general.common.impl.security.CsrfRequestMatcher;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    String[] unsecuredResources = new String[] { "/login", "/security/**", "/services/rest/**",
